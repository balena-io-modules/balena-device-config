...
exports.authenticateWithApplicationKey = function(config, applicationNameOrId) {
  return resin.models.application.getApiKey(applicationNameOrId).then(function(apiKey) {
    config.apiKey = apiKey;
    return config;
  });
};
...
exports.authenticateWithProvisioningKey = function(config, applicationNameOrId) {
  return resin.models.application.generateProvisioningKey(applicationNameOrId).then(function(apiKey) {
    config.apiKey = apiKey;
    return config;
  });
};
...
exports.authenticateWithDeviceKey = function(config, uuid, customDeviceApiKey) {
